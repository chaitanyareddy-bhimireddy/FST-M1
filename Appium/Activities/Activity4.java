...
public class Activity4 {
	    ...
	    public void addition() {
	    	...
	    	driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"First name\"]")).sendKeys("chaitanya ");
	    	driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"Last name\"]")).sendKeys("Bhimireddy");
	    	driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"+1\"]")).sendKeys("+917653723455");
	    	...
	    	Assert.assertEquals(name.getText(), "chaitanya Bhimireddy");
	    }
